    ...
    <>
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-800 filter  drop-shadow-lg">
            {title}
          </h1>
          <p>{text}</p>
          <a
          ...
          >
            <button
              type="button"
              className="button-theme bg-slate-900 py-1.5 text-slate-100"
            >
              {btn}
            </button>
          </a>
