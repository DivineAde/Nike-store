...
const Footer = ({ footerAPI: { titles, links } }) => {
  return (
    <>
      <footer className="bg-theme pt-7 pb-5 mt-6">
        <div className="nike-container text-slate-200">
          ...
          <div className="mt-5 text-center">
            <p className="text-sm md:text-center">
              Copyright
              <sub className="text-base font-bold text-center">&copy;</sub> All
              right reserved Rights 2023{" "}
              <span className="font-semibold">TOPG.DEV</span>
            </p>
          </div>
        </div>
      </footer>
