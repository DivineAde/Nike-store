...
import {
  selectCartState,
  setCloseCart,
  selectCartItems, setClearCartItems, setGetTotals, selectTotalAmount, selectTotalQTY
} from "../app/CartSlice";
      ...
      >
        ...
        >
          ...
          {cartItems?.length === 0 ? (
            ...
            <div>
              <div className="flex items-start justify-start flex-col gap-y-7 overflow-y-scroll scroll-smooth h-[81vh] scroll-hidden py-3">
